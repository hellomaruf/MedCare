    ...
    <div className='max-w-7xl mx-auto my-20'>
          <div className="grid grid-cols-6 gap-4 border-2 bg-gray-50 rounded-xl p-4">
              <div className="col-span-2 space-y-6 bg-gradient-to-r from-[#2089CB] to-[#1a7fbd] rounded-xl p-6">
                  <div className=''>
                    <h2 className='text-2xl font-semibold pb-2 text-white'>Contact Information</h2>
                <p className='text-gray-100 text-sm'>
                At MedCare, we are dedicated to providing you with exceptional healthcare services. Whether you need support, have a general inquiry, or wish to schedule an appointment, our team is here to help.
                </p>
                  </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <input
                className="w-full rounded-lg border-gray-200 p-3  border border-gray-300 focus:outline-none focus:border-[#1F88CA] text-sm"
          ...
          <div>
            ...
            <input
              className="w-full rounded-lg border-gray-200 p-3  border border-gray-300 focus:outline-none focus:border-[#1F88CA] p-3 text-sm"
              placeholder="Name"
              type="text"
              id="subject"
            />
